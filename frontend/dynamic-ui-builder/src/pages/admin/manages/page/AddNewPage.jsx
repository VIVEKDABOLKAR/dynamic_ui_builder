...
import { createPage } from '../../../../api/adminPageApi'
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Add New Page</h1>
          <p className="mt-1 text-sm text-slate-500">Create a new UI page using the backend API.</p>
        </div>
